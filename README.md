...
| Platform | Versions tested/supported |
|---|---|
| cordova-android | 14, 15 (Java 17+, minSdk 24, AGP 8.x / Gradle 8.x) |
| cordova-ios | 7, 8 (Xcode 15+, iOS 13+, Objective-C) |
| Browser | For development/testing |
